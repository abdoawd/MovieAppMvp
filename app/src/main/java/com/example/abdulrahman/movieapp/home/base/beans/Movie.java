...
public class Movie implements Parcelable {
    ...
    public Movie(String posterPath, boolean adult, String overview, String releaseDate,
                 ...
                 String title, String backdropPath, Double popularity, String voteCount, Boolean video,
                 String voteAverage) {
    ...
    public Movie(String poster_path, String overview, String release_date, String original_title, int id, String vote_average) {
        this.id = id;
